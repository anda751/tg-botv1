...
export interface ApiHandoverRequestHandoverRequest
  extends Struct.CollectionTypeSchema {
  collectionName: 'handover_requests';
  info: {
    displayName: 'handover-request';
    pluralName: 'handover-requests';
    singularName: 'handover-request';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    picked_up_by: Schema.Attribute.Relation<
      'manyToOne',
    ...
    status_handover: Schema.Attribute.Enumeration<
      ['pending', 'approved', 'cancelled', 'timeout']
    > &
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    status_project: Schema.Attribute.Enumeration<['active', 'closed']> &
...
export interface ApiProofImageProofImage extends Struct.CollectionTypeSchema {
  collectionName: 'proof_images';
  info: {
    displayName: 'proof-image';
    pluralName: 'proof-images';
    singularName: 'proof-image';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::proof-image.proof-image'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    report_text: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 5;
      }>;
...
export interface ApiTaskLogTaskLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    action: Schema.Attribute.Enumeration<
      ['created', 'submitted', 'approved', 'rejected', 'handover', 'picked_up']
    > &
      Schema.Attribute.Required;
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    creator: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    current_owner: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    handover_requests: Schema.Attribute.Relation<
      'oneToMany',
      'api::handover-request.handover-request'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    proof_images: Schema.Attribute.Relation<
      'oneToMany',
      'api::proof-image.proof-image'
    >;
    publishedAt: Schema.Attribute.DateTime;
    status_task: Schema.Attribute.Enumeration<
      ['in_progress', 'under_review', 'waiting_pickup', 'done']
    > &
      Schema.Attribute.DefaultTo<'in_progress'>;
    task_log: Schema.Attribute.Relation<'oneToMany', 'api::task-log.task-log'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    role_app: Schema.Attribute.Enumeration<['manager', 'staff']>;
    tasks: Schema.Attribute.Relation<'oneToMany', 'api::task.task'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::handover-request.handover-request': ApiHandoverRequestHandoverRequest;
      'api::project.project': ApiProjectProject;
      'api::proof-image.proof-image': ApiProofImageProofImage;
