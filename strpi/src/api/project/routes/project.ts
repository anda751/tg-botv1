export default {
  routes: [
    ...
    { method: 'GET',    path: '/projects/export/list',        handler: 'project.exportList',    config: { auth: false } },
    { method: 'GET',    path: '/projects/:id/export',         handler: 'project.exportDetail',  config: { auth: false } },
